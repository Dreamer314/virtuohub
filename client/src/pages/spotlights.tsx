  ...
  return (
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="floating-element absolute top-28 left-20 w-18 h-18 bg-yellow-500/15 rounded-full blur-xl"></div>
        <div className="floating-element absolute top-52 right-16 w-22 h-22 bg-orange-500/20 rounded-full blur-xl" style={{ animationDelay: '-3s' }}></div>
        <div className="floating-element absolute bottom-40 left-1/4 w-20 h-20 bg-amber-500/15 rounded-full blur-xl" style={{ animationDelay: '-5s' }}></div>
        <div className="floating-element absolute top-80 right-1/3 w-16 h-16 bg-red-500/20 rounded-full blur-xl" style={{ animationDelay: '-1.8s' }}></div>
      </div>
