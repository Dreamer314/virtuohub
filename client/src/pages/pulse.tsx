                      ...
                      <article className="enhanced-card hover-lift rounded-xl p-6 border border-sidebar-border hover:border-primary/30 transition-all">
                        <div className="flex items-start justify-between mb-4">
                          <div>
                            ...
                            <h3 className="text-xl font-semibold text-foreground mb-2">
                              2025 Immersive Economy Forecast
                            </h3>
                            <p className="text-sm text-muted-foreground mb-3">
                              Comprehensive market analysis with revenue projections, emerging platform insights, and strategic recommendations for creators.
                            </p>
                          </div>
                          <div className="text-right">
                            <div className="text-2xl font-bold text-accent">$29</div>
                            <div className="text-xs text-muted-foreground">Available Jan 15</div>
                          </div>
                        </div>
                        <div className="flex items-center justify-between">
                          <div className="flex gap-2">
                            <span className="px-2 py-1 bg-primary/20 text-primary rounded text-xs">Market Analysis</span>
