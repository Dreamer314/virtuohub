                ...
                <main>
                  <div className="mb-8">
                    ...
                    <p className="text-center text-lg text-muted-foreground mb-2">
                      Quick polls on Immersive Economy topics.
                    </p>
                  ...
                  {isLoading ? (
                    <div className="space-y-6">
                      {[...Array(3)].map((_, i) => (
                        <div key={i} className="enhanced-card p-6 animate-pulse">
                    ...
                    <div className="text-center py-12">
                      ...
                      <h3 className="text-lg font-medium text-foreground mb-2">No pulse posts yet</h3>
                      <p className="text-muted-foreground">Be the first to share industry insights!</p>
                    </div>
                  )}
                </main>
