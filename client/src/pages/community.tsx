      ...
      <div className="flex">
        ...
        <div className="flex-1 lg:ml-64 lg:mr-80">
          ...
          <main>
            ...
            {/* Latest News */}
            {currentTab === 'all' && (
              <div className="mb-8" data-testid="latest-news-section">
                <div className="flex items-center space-x-2 mb-4">
                  ...
                  <div className="h-px bg-gradient-to-r from-orange-500 via-transparent to-transparent flex-1"></div>
                </div>
                
                <div className="glass-card rounded-xl p-4">
                  <div className="space-y-3">
                    {/* News Item 1 */}
                    <div className="flex items-start gap-3 pb-3 border-b border-border/30 last:border-b-0 last:pb-0" data-testid="news-item-1">
                      <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0"></div>
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          <span className="text-xs font-medium text-orange-500 bg-orange-500/10 px-2 py-0.5 rounded-full">Breaking</span>
                          <span className="text-xs text-muted-foreground">2 hours ago</span>
                        </div>
                        <h3 className="text-sm font-medium text-foreground mb-1 line-clamp-2">
                          Unity announces new Real-Time Ray Tracing features for mobile VR platforms
                        </h3>
                        <p className="text-xs text-muted-foreground line-clamp-1">
                          Enhanced visual fidelity coming to Quest 3 and upcoming standalone headsets this fall.
                        </p>
                      </div>
                    </div>

                    {/* News Item 2 */}
                    <div className="flex items-start gap-3 pb-3 border-b border-border/30 last:border-b-0 last:pb-0" data-testid="news-item-2">
                      <div className="w-2 h-2 rounded-full bg-blue-500 mt-2 flex-shrink-0"></div>
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          <span className="text-xs font-medium text-blue-500 bg-blue-500/10 px-2 py-0.5 rounded-full">Platform</span>
                          <span className="text-xs text-muted-foreground">4 hours ago</span>
                        </div>
                        <h3 className="text-sm font-medium text-foreground mb-1 line-clamp-2">
                          VRChat Creator Economy beta launches with revenue sharing for world creators
                        </h3>
                        <p className="text-xs text-muted-foreground line-clamp-1">
                          First 1000 creators get early access to monetization tools and analytics dashboard.
                        </p>
                      </div>
                    </div>

                    {/* News Item 3 */}
                    <div className="flex items-start gap-3 pb-3 border-b border-border/30 last:border-b-0 last:pb-0" data-testid="news-item-3">
                      <div className="w-2 h-2 rounded-full bg-purple-500 mt-2 flex-shrink-0"></div>
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          <span className="text-xs font-medium text-purple-500 bg-purple-500/10 px-2 py-0.5 rounded-full">Industry</span>
                          <span className="text-xs text-muted-foreground">6 hours ago</span>
                        </div>
                        <h3 className="text-sm font-medium text-foreground mb-1 line-clamp-2">
                          Roblox reports 70M daily active users, exceeds Q3 revenue projections
                        </h3>
                        <p className="text-xs text-muted-foreground line-clamp-1">
                          Strong growth in virtual item sales and developer payouts drives record quarter.
                        </p>
                      </div>
                    </div>

                    {/* News Item 4 */}
                    <div className="flex items-start gap-3 pb-3 border-b border-border/30 last:border-b-0 last:pb-0" data-testid="news-item-4">
                      <div className="w-2 h-2 rounded-full bg-green-500 mt-2 flex-shrink-0"></div>
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          <span className="text-xs font-medium text-green-500 bg-green-500/10 px-2 py-0.5 rounded-full">Tools</span>
                          <span className="text-xs text-muted-foreground">1 day ago</span>
                        </div>
                        <h3 className="text-sm font-medium text-foreground mb-1 line-clamp-2">
                          Blender 4.0 introduces enhanced geometry nodes for procedural world building
                        </h3>
                        <p className="text-xs text-muted-foreground line-clamp-1">
                          New node types specifically designed for game environment and metaverse asset creation.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-4 pt-3 border-t border-border/30">
                    <Button 
                      variant="ghost" 
                      size="sm" 
                      className="w-full text-xs text-muted-foreground hover:text-foreground hover:bg-background/50 transition-colors"
                      data-testid="view-all-news-button"
                    >
                      View All News →
                    </Button>
                  </div>
