...
import { TrendingUp, Calendar, Star, Zap, Flame, Clock } from "lucide-react";
    ...
    <aside className="w-full">
      <div className="sticky top-4 max-h-[calc(100vh-2rem)] overflow-y-auto space-y-6">
        ...
        <Link href="/spotlights" className="block">
          <div className="bg-sidebar enhanced-card glow-border rounded-xl p-6 border border-sidebar-border hover:border-primary/30 transition-all duration-300 hover:shadow-md cursor-pointer" data-testid="creator-spotlight">
            <h3 className="text-lg font-display font-semibold mb-4 flex items-center">
        ...
        {/* Pulse Reports & Trending */}
        <div className="bg-sidebar enhanced-card glow-border rounded-xl overflow-hidden border border-sidebar-border hover:border-primary/30 transition-all duration-300 hover:shadow-md" data-testid="pulse-trending">
          {/* Top Half: Pulse Reports */}
          ...
          <Link href="/trending" className="block">
            <div className="p-6 hover:bg-muted/20 transition-colors cursor-pointer">
              <h3 className="text-lg font-display font-semibold mb-3 flex items-center">
