  ...
  return [
    {
      ...
      imageUrl: '/images/vrchat-avatars.png',
      images: ['/images/vrchat-avatars.png', '/images/avatar-showcase.png'],
      files: [],
    ...
    // Creator Insights Interview Posts
    {
      ...
      imageUrl: '/images/vr-studio.png',
      images: ['/images/vr-studio.png', '/images/team-photo.png'],
      files: [],
