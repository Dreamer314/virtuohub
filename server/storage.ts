  ...
  private seedData() {
    ...
    const sampleUsers = [
      {
        ...
        avatar: '/src/attached_assets/generated_images/VR_creator_avatar_portrait_f2a1cea7.png',
      ...
      },
      {
        ...
        avatar: '/src/attached_assets/generated_images/Minecraft_creator_avatar_6ea93044.png',
    ...
    const samplePosts = [
      ...
      },
      {
        ...
        imageUrl: '/src/attached_assets/generated_images/Roblox_Studio_development_workspace_b4b038dc.png',
        images: [],
        files: [],
        links: [],
        category: 'Jobs & Gigs',
